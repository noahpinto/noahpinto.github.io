...
var AppComponent = /** @class */ (function () {
    function AppComponent(http) {
        ...
        this.http.get('https://private-37ba9-assignment39.apiary-mock.com/venues').subscribe(function (data) {
            for (var i = 0; data; i++) {
                _this.curlatlong = new google.maps.LatLng(data[i].lat, data[i].long);
                var marker = void 0;
                ...
                var content = "<h4> " + data[i].label + "</h4>";
...
module.exports = __webpack_require__(/*! C:\nodejs\ag\src\main.ts */"./src/main.ts");
